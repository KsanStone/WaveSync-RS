...
impl SpectrumVisualizer {
    ...
    pub fn update_axis(&self, plot_data: &mut PlotData) {
        plot_data.x_axis = Some(crate::ui::plot::Axis { min: 0.0, max: 20000.0, logarithmic: true });
        plot_data.y_axis = Some(crate::ui::plot::Axis { min: 0.0, max: 1.0, logarithmic: false });
    }
}
...
impl CallbackTrait for SpectrumVisualizerCallback {
    ...
    fn paint(&self, info: PaintCallbackInfo, render_pass: &mut RenderPass<'static>, callback_resources: &CallbackResources) {
